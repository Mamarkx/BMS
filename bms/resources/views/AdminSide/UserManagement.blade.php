<x-admin-layout>
    <div class="w-full h-screen p-10  bg-gray-50 ">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
            ...
            <button onclick="openAddUserModal()"
                class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-3 rounded-lg shadow-md">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
            <div
                ...
                <div class="relative w-full sm:w-72">
                    <input id="searchInput" type="text" placeholder="Search Users..." onkeyup="searchResidents()"
                            ...
                            <tr class="hover:bg-blue-50 transition-all duration-150">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <!-- Delete Button -->
                                        <form id="deleteForm_{{ $p->id }}"
                                            action="{{ route('DeleteUserAccount', $p->id) }}" method="POST"
                                            class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
    ...
    <dialog id="addUserModal" class="modal backdrop:bg-black/60 backdrop:backdrop-blur-sm">
        <div
            class="modal-box max-w-3xl bg-white rounded-2xl shadow-2xl overflow-hidden transition-all duration-200 scale-95 opacity-0">
            ...
            <div class="px-6 py-6 max-h-[75vh] overflow-y-auto bg-gray-50/50">
                <form id="editEmployeeForm" method="POST" action="{{ route('UpdateUserAcc') }}">
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <div>
                                    <label for="edit_suffix"
                                        class="font-medium text-sm text-gray-600 mb-1 block">Suffix (Optional)</label>
                                ...
                                <div>
                                    <label for="edit_status"
                                        class="font-medium text-sm text-gray-600 mb-1 block">Status</label>
                                ...
                                <div>
                                    <label for="edit_role"
                                        class="font-medium text-sm text-gray-600 mb-1 block">Role</label>
                        ...
                        <div class="p-5 bg-white rounded-lg shadow-sm border border-gray-100">
                            <h4 class="text-lg font-semibold text-gray-700 mb-4 pb-2 border-b border-gray-100">Account
                                Information</h4>
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
                                <div>
                                    <label for="edit_email"
                                        class="font-medium text-sm text-gray-600 mb-1 block">Email</label>
                                ...
                                <div>
                                    <label for="edit_password"
                                        class="font-medium text-sm text-gray-600 mb-1 block">Password</label>
