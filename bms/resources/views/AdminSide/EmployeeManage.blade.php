<x-admin-layout>
    <div class="w-full p-10 h-screen  bg-gray-50 ">
        <!-- Header -->
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
            <!-- Controls -->
            <div
                class="px-6 py-5 bg-white/60 backdrop-blur-md  shadow-md border border-gray-200 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">

                <!-- Left Section: Title + Filter -->
                <!-- Professional Filter Section -->
                <div
                    class="flex flex-col sm:flex-row sm:items-center gap-4 bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
                    ...
                    <div class="relative sm:ml-auto w-full sm:w-64">
                        ...
                        <i
                            class="fa-solid fa-chevron-down absolute right-3 top-3 text-gray-400 pointer-events-none"></i>
                    </div>
                ...
                <table class="min-w-full text-sm text-gray-700">
                    <thead class="bg-gradient-to-r from-blue-600 to-blue-700 text-white text-left">
                        <tr>
                            ...
                            <th class="px-6 py-3 font-semibold uppercase text-xs tracking-wider text-center">Actions
                            </th>
                        </tr>
                    </thead>
                ...
                <form action="{{ route('AddEmployee') }}" method="POST" id="employeeForm">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                            ...
                            <div>
                                <label for="birthdate"
                                    class="block text-sm font-semibold text-gray-700 mb-2">Birthdate *</label>
                    ...
                    <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
                        ...
                        <button type="submit"
                            class="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-lg font-semibold transition-all shadow-lg shadow-blue-500/30">
        ...
        <div class="modal-box max-w-5xl bg-white rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.15)] p-0 overflow-hidden">
            ...
            <div class="px-10 py-8 bg-gray-50 max-h-[75vh] overflow-y-auto">
                ...
                <div class="flex flex-col md:flex-row gap-6 items-center md:items-start mb-10">
                    <div
                        class="w-36 h-36 bg-gradient-to-br from-indigo-100 to-blue-50 rounded-full flex items-center justify-center border border-indigo-200">
                    ...
                    <div class="text-center md:text-left">
                        ...
                        <span id="v_status"
                            class="inline-block mt-3 px-3 py-1 text-sm font-semibold rounded-full"></span>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-8">
                    ...
                    <div class="p-6 grid md:grid-cols-3 gap-5 text-gray-700">
                        <div><span class="font-semibold text-gray-600">Employee ID:</span>
                            <p id="v_personnel_id"></p>
                        </div>
                        <div><span class="font-semibold text-gray-600">Gender:</span>
                            <p id="v_gender"></p>
                        </div>
                        <div><span class="font-semibold text-gray-600">Birthdate:</span>
                            <p id="v_birthdate"></p>
                        </div>
                        <div><span class="font-semibold text-gray-600">Hire Date:</span>
                            <p id="v_hire_date"></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-8">
                    ...
                    <div class="p-6 grid md:grid-cols-2 lg:grid-cols-3 gap-5 text-gray-700">
                        <div><span class="font-semibold text-gray-600">Contact Number:</span>
                            <p id="v_contact_number"></p>
                        </div>
                        <div><span class="font-semibold text-gray-600">Email:</span>
                            <p id="v_email"></p>
                        </div>
                        <div class="lg:col-span-3"><span class="font-semibold text-gray-600">Address:</span>
                            <p id="v_address" class="leading-snug"></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <div class="p-6 grid md:grid-cols-2 gap-5 text-gray-700">
                        <div><span class="font-semibold text-gray-600">Contact Person:</span>
                            <p id="v_emergency_contact"></p>
                        </div>
                        <div><span class="font-semibold text-gray-600">Contact Number:</span>
                            <p id="v_emergency_number"></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <form id="editEmployeeForm" method="POST" action="{{ route('EditEmployee') }}">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="p-5 bg-white rounded-lg shadow-sm border border-gray-100">
                            <h4 class="text-lg font-semibold text-gray-700 mb-4 pb-2 border-b border-gray-100">Personal
                                Information</h4>
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                <div>
                                    <label for="edit_first_name"
                                        class="font-medium text-sm text-gray-600 mb-1 block">First Name</label>
                                ...
                                <div>
                                    <label for="edit_middle_name"
                                        class="font-medium text-sm text-gray-600 mb-1 block">Middle Name
                                        (Optional)</label>
                                ...
                                <div>
                                    <label for="edit_last_name"
                                        class="font-medium text-sm text-gray-600 mb-1 block">Last Name</label>
                                ...
                                <div>
                                    <label for="edit_gender"
                                        class="font-medium text-sm text-gray-600 mb-1 block">Gender</label>
                                ...
                                <div>
                                    <label for="edit_birthdate"
                                        class="font-medium text-sm text-gray-600 mb-1 block">Birthdate</label>
                                ...
                                <div>
                                    <label for="edit_contact_number"
                                        class="font-medium text-sm text-gray-600 mb-1 block">Contact Number</label>
                        ...
                        <div class="p-5 bg-white rounded-lg shadow-sm border border-gray-100">
                            <h4 class="text-lg font-semibold text-gray-700 mb-4 pb-2 border-b border-gray-100">
                                Residential Address</h4>
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">

                                <div class="lg:col-span-3">
                                    <label for="edit_address"
                                        class="font-medium text-sm text-gray-600 mb-1 block">Address</label>
                        ...
                        <div class="p-5 bg-white rounded-lg shadow-sm border border-gray-100">
                            <h4 class="text-lg font-semibold text-gray-700 mb-4 pb-2 border-b border-gray-100">Job
                                Information</h4>
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                <div>
                                    <label for="edit_email" class="font-medium text-sm text-gray-600 mb-1 block">Work
                                        Email</label>
                                ...
                                <div>
                                    <label for="edit_hire_date"
                                        class="font-medium text-sm text-gray-600 mb-1 block">Hire Date</label>
                                ...
                                <div>
                                    <label for="edit_status"
                                        class="font-medium text-sm text-gray-600 mb-1 block">Employment Status</label>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label for="edit_emergency_contact"
                                        class="font-medium text-sm text-gray-600 mb-1 block">Contact Name</label>
                                    <input type="text" id="edit_emergency_contact" name="emergency_contact"
                                        class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-gray-700 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition duration-150">
                                </div>

                                <div>
                                    <label for="edit_emergency_number"
                                        class="font-medium text-sm text-gray-600 mb-1 block">Contact Number</label>
    ...
    <script>
        function viewRecord(personnel) {
            ...
            switch (status) {
                case 'Active':
                    statusEl.addClass('bg-green-100 text-green-700 border border-green-200');
                    break;
                case 'Inactive':
                    statusEl.addClass('bg-gray-100 text-gray-700 border border-gray-200');
                    break;
                case 'Resigned':
                    statusEl.addClass('bg-yellow-100 text-yellow-700 border border-yellow-200');
                    break;
                case 'Terminated':
                    statusEl.addClass('bg-red-100 text-red-700 border border-red-200');
                    break;
                default:
                    statusEl.addClass('bg-blue-100 text-blue-700 border border-blue-200');
            }
...
<script>
    $(document).ready(function() {
        ...
        const $emptyRow = $(
            '<tr id="noDataRow" class="hidden"><td colspan="6" class="px-6 py-6 text-center text-gray-500 text-sm">No Employee Found</td></tr>'
        );
