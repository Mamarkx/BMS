<x-admin-layout>
    <div class="w-full p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <div class="space-y-2">
                <h3 class="font-semibold text-3xl text-gray-800">Barangay ID Applications</h3>
                    ...
                    @forelse ($data as $d)
                        <tr class="border-b border-gray-300 hover:bg-gray-50 text-sm text-gray-800">
                            ...
                            <td class="py-4 px-6 text-lg flex items-center gap-2">
                                ...
                                <button class="text-gray-600 hover:text-green-800"><i
                                ...
                                <form id="approveForm{{ $d->id }}"
                                    action="{{ route('approve.formID', $d->id) }}" method="POST">
                                    @csrf
                                </form>
