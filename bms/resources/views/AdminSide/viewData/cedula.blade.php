<x-admin-layout>
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 overflow-y-auto">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
            ...
            <!-- Grid 4 Columns -->
            <div class="px-6 py-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-gray-700">
                    ...
                    <div class="p-6 bg-white rounded-xl shadow-sm border border-gray-200">
                        ...
                        <dl class="space-y-3 text-sm">
                            ...
                            <div class="flex justify-between border-b border-gray-100 pb-2">
                                ...
                                <dd class="text-right font-medium text-gray-800">{{ $cedula->tin ?? 'No Data' }}</dd>
                            </div>
                            <div class="flex justify-between border-b border-gray-100 pb-2">
                ...
                <div class="space-y-6">
                    <div class="p-6 bg-white rounded-xl shadow-sm border border-gray-200">
                        <h5 class="font-semibold text-gray-900 mb-4 text-lg flex items-center gap-2">
                            <i class="fas fa-chart-line text-indigo-600"></i> Economic & Income
                        </h5>
                        <dl class="space-y-3 text-sm">
                            <div class="flex justify-between border-b border-gray-100 pb-2">
                            ...
                            <div class="flex justify-between border-b border-gray-100 pb-2">
                                ...
                                <dd class="text-right font-medium">
                                    ₱{{ number_format($cedula->total_gross_receipt_fr_business, 2) }}</dd>
                            </div>
                            <div class="flex justify-between border-b border-gray-100 pb-2">
                                <dt class="font-medium text-gray-500">Salary Earnings:</dt>
                                <dd class="text-right">₱{{ number_format($cedula->total_earning_fr_salaries, 2) }}</dd>
                            </div>
                            <div class="flex justify-between">
                                <dt class="font-medium text-gray-500">Real Property Income:</dt>
                                <dd class="text-right">₱{{ number_format($cedula->total_income_fr_realproperty, 2) }}
                                </dd>
                            </div>
                        </dl>
                    </div>
                ...
                <div class="space-y-6">
                    <div class="p-6 bg-white rounded-xl shadow-sm border border-gray-200">
                        <h5 class="font-semibold text-gray-900 mb-4 text-lg flex items-center gap-2">
                            <i class="fas fa-envelope-open text-indigo-600"></i> Contact & Application
                        </h5>
                        <dl class="space-y-3 text-sm">
                            <div class="flex justify-between border-b border-gray-100 pb-2">
                            ...
                            <div class="flex justify-between border-b border-gray-100 pb-2">
                                ...
                                <dd class="text-right font-bold text-green-700">
                                    ₱{{ number_format($cedula->amount, 2) }}</dd>
                            </div>
                            <div class="flex justify-between">
                ...
                <!-- Uploaded Proofs (ID + Signature) -->
                <div class="space-y-6">
                    <div class="p-6 bg-white rounded-xl shadow-sm border border-gray-200">
                        <h5 class="font-semibold text-gray-900 mb-4 text-lg flex items-center gap-2">
                            <i class="fas fa-id-card text-indigo-600"></i> Uploaded Proofs
                        </h5>
                            ...
                            @if ($cedula->id_proof)
                                ...
                                <div x-show="openID" x-transition
                                    ...
                                    <div class="relative max-w-full max-h-full">
                                        ...
                                        <img src="{{ asset('storage/' . $cedula->id_proof) }}" alt="Full Size ID Proof"
