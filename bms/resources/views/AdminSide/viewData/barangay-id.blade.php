<x-admin-layout>
    ...
    <div class="max-h-screen  bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div class="w-full">
            ...
            <!-- Main Card -->
            <div
                class="bg-white max-h-96 h-full w-full overflow-y-auto  rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
