            ...
            <div class="space-y-6">
                ...
                <div class="bg-blue-50 border border-blue-200 p-6 rounded-2xl shadow">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="rounded-lg p-4 flex flex-col">
                            ...
                            <select name="civil_status" class="w-full border border-gray-300 bg-white text-black rounded-lg p-2" required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <div class="rounded-lg p-4 flex flex-col">
                            ...
                            <input type="text" name="citizenship" value="{{ auth()->user()->citizenship }}" class="w-full border bg-white text-black border-gray-300 rounded-lg p-2" required>
                        </div>
                        <div class="rounded-lg p-4 flex flex-col">
                            <label class="block mb-2 text-sm font-medium text-gray-700">Birth Place *</label>
                            <input type="text" name="place_of_birth" class="w-full border bg-white text-black border-gray-300 rounded-lg p-2" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <div class="rounded-lg p-4 flex flex-col">
                            ...
                            <input type="number" name="height" value="{{ auth()->user()->height }}" class="w-full border bg-white text-black border-gray-300 rounded-lg p-2">
                        </div>
                        <div class="rounded-lg p-4 flex flex-col">
                            <label class="block mb-2 text-sm font-medium text-gray-700">Weight (kg)</label>
                            <input type="number" name="weight" value="{{ auth()->user()->weight }}" class="w-full border bg-white text-black border-gray-300 rounded-lg p-2">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-blue-50 border border-blue-200 p-6 rounded-2xl shadow">
                    ...
                    <div class="rounded-lg p-4 mb-4 flex flex-col">
                        ...
                        <input type="text" name="tin" class="bg-white text-black w-full border border-gray-300 rounded-lg p-2">
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="rounded-lg p-4 flex flex-col">
                            <label class="block mb-2 text-sm font-medium text-gray-700">Gross Receipt from Business</label>
                            <input type="number" step="0.01" name="total_gross_receipt_fr_business" class="bg-white text-black w-full border border-gray-300 rounded-lg p-2">
                        </div>
                        <div class="rounded-lg p-4 flex flex-col">
                            <label class="block mb-2 text-sm font-medium text-gray-700">Earnings from Salaries</label>
                            <input type="number" step="0.01" name="total_earning_fr_salaries" class="bg-white text-black w-full border border-gray-300 rounded-lg p-2">
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg p-4 mt-4 flex flex-col">
                        ...
                        <input type="number" step="0.01" name="total_income_fr_realproperty" class="bg-white text-black w-full border border-gray-300 rounded-lg p-2">
                    </div>
                </div>
                ...
                <div class="bg-blue-50 border border-blue-200 p-6 rounded-2xl shadow">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="border border-gray-300 rounded-lg p-4 flex flex-col space-y-3">
                            ...
                            <div id="signature-root" class="w-full h-60 bg-white border border-gray-300 rounded-lg"></div>

                            <div class="flex justify-end space-x-2 mt-2">
                                <button type="button" id="reset-signature" class="px-3 py-1 bg-red-500 text-white rounded-lg text-sm">Clear</button>
                                <button type="button" id="save-signature" class="px-3 py-1 bg-blue-500 text-white rounded-lg text-sm">Save</button>
                            </div>
...
$(document).ready(function() {
    $("#previewSummary").click(function() {
        let sigText = $("#signature_data").val() ? 'Signature drawn' : ($("#upload_signature")[0].files.length ? $("#upload_signature")[0].files[0].name : 'No signature provided');
        let summaryHtml = `
