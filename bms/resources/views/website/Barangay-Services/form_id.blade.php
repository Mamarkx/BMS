<x-layout>
    <section class="py-24 bg-white min-h-screen">
        <div class="container mx-auto px-4 md:px-6">
            ...
            <form id="applicationForm" action="{{ route('submit.form_id', ['service_slug' => $title]) }}" method="POST"
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-blue-50 border border-blue-200 p-6 rounded-2xl shadow">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="religion" value="{{ auth()->user()->religion }}"
                                    class="w-full border border-gray-300 rounded-lg p-2 bg-white focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div>
                    ...
                    <div class="flex justify-end mt-8 space-x-4">
                        <button type="button" onclick="window.location.href='{{ route('Services') }}'"
                            class="px-6 py-3 text-gray-600 bg-gray-200 rounded-lg font-semibold hover:bg-gray-300">Cancel</button>
                        <button type="button" id="reviewBtn"
                            class="px-6 py-3 text-white bg-blue-600 rounded-lg font-semibold hover:bg-blue-700">Review
                            & Submit</button>
                    </div>
                </div>
            </form>
    ...
    <div id="reviewModal" class="fixed inset-0 flex items-center justify-center bg-black/60 hidden z-50">
        <div
            class="bg-white p-8 rounded-xl shadow-2xl max-w-4xl w-full transform transition-all duration-300 scale-95">
            ...
            <div class="flex justify-end mt-8 space-x-4 border-t pt-4">
                <button id="editBtn"
                    class="px-5 py-2 text-gray-600 bg-gray-200 rounded-lg font-medium hover:bg-gray-300"><i
                        class="fa-solid fa-pen-to-square mr-1"></i> Edit</button>
                <button id="confirmSubmitBtn"
                    class="px-5 py-2 text-white bg-blue-600 rounded-lg font-medium hover:bg-blue-700 shadow"><i
                        class="fa-solid fa-paper-plane mr-1"></i> Confirm & Submit</button>
            </div>
        </div>
    </div>
                ...
                if ($('#applicationForm')[0].checkValidity()) {
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div class="col-span-4 mt-4">
                            <h3 class="font-semibold text-blue-700 mb-2">Residency</h3>
                        </div>
                        ...
                        <div class="col-span-4 mt-4">
                            <h3 class="font-semibold text-blue-700 mb-2">Emergency Contact</h3>
                        </div>
