...
<body class="bg-gradient-to-br from-blue-200 via-white to-blue-300">
  <div class="min-h-screen w-full flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-7xl grid lg:grid-cols-2 gap-0 bg-white rounded-3xl shadow-2xl overflow-hidden">
      ...
      <!-- Left Side - Branding -->
      <div class="hidden lg:flex flex-col justify-center items-center bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 p-16 text-white relative overflow-hidden">
        <div class="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30"></div>

        <div class="relative z-10 text-center">
          <div class="mb-8">
            <img src="{{ asset('images/san-agustin.png') }}" class="mx-auto h-36 w-36 drop-shadow-2xl" alt="Barangay Logo" />
          </div>
        ...
        <div class="absolute bottom-0 left-0 w-full h-40 bg-gradient-to-t from-blue-900/50 to-transparent"></div>
      </div>
      ...
      <div class="p-8 lg:p-16 flex flex-col justify-center w-full">
        ...
        <div class="lg:hidden text-center mb-10">
          <img src="{{ asset('images/san-agustin.png') }}" class="mx-auto h-24 w-24 mb-4" alt="Barangay Logo" />
        ...
        <div class="mb-10 text-center lg:text-left">
          ...
          @endif
        <!-- Login Form -->
        <form action="{{ route('admin.login') }}" method="POST" class="mt-4 space-y-6 max-w-md mx-auto lg:mx-0">
          @csrf       
          <!-- Email Input -->
          <div>
