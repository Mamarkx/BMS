    ...
    <div class="glass rounded-3xl shadow-2xl overflow-hidden w-full h-full max-h-[95vh] flex flex-col">
      ...
      <div class="px-8 py-6 overflow-y-auto flex-1 space-y-6">
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <p class="text-sm text-gray-600 leading-relaxed">
                We've sent a 6-digit verification code to your registered email address. Enter it below to continue.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="mt-4 flex flex-col gap-3">
          <button type="button" class="w-full py-3 px-4 border-2 border-gray-200 hover:border-blue-500 hover:bg-blue-50 text-gray-700 hover:text-blue-700 font-medium rounded-xl flex items-center justify-center gap-2 transition duration-200">
            <i class="fa-solid fa-rotate-right"></i>
            <span>Resend Verification Code</span>
          </button>
          <a href="{{ route('LoginAdmin') }}" class="w-full py-3 px-4 text-center border-2 border-gray-200 hover:border-blue-500 hover:bg-blue-50 text-gray-700 hover:text-blue-700 font-medium rounded-xl transition duration-200">
