...
<div class="w-full p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div class="space-y-2">
            <h3 class="font-semibold text-3xl text-gray-800">Cedula Applications</h3>
    ...
    <div class="overflow-x-auto bg-white rounded-md border border-gray-300">
                    ...
                    @foreach ($data as $d)
                        <tr class="border-b border-gray-300 hover:bg-gray-50 text-sm text-gray-800">
                            ...
                            <td class="py-4 px-6 text-lg flex items-center gap-2">
                                ...
                                <!-- Approve -->
                                <form id="approveForm{{ $d->id }}" action="{{ route('approve.cedula', $d->id) }}" method="POST">
                                    @csrf
                                </form>
        ...
        @else
            <div class="text-center py-6 text-gray-500 text-lg">No requests available.</div>
        @endif
    </div>
