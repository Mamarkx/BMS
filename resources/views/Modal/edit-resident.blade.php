<div id="edit-resident-modal" class="fixed inset-0 flex items-center justify-center z-50 bg-black/60 ">
    <div class="bg-white rounded-2xl w-full max-w-4xl shadow-2xl max-h-[90vh] overflow-hidden m-4">
        ...
        <div class="overflow-y-auto max-h-[calc(90vh-180px)] px-8 py-6">
            <form id="editResidentForm" method="POST" action="{{ route('residents.update', $resident->resident_id) }}" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div class="space-y-2">
                            <label class="block text-sm font-semibold text-slate-700">Gender <span class="text-red-500">*</span></label>
                            <select name="gender" 
                                    class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200" required>
                        ...
                        <div class="space-y-2">
                            <label class="block text-sm font-semibold text-slate-700">Birthdate <span class="text-red-500">*</span></label>
                            <input type="date" name="birth_date" value="{{ $resident->birth_date }}" 
                                   class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-200" required>
                        </div>

                        <div class="space-y-2">
                            <label class="block text-sm font-semibold text-slate-700">Civil Status <span class="text-red-500">*</span></label>
                ...
                <div class="space-y-5">
                    ...
                    <div class="space-y-2">
                        <label class="block text-sm font-semibold text-slate-700">Complete Address <span class="text-red-500">*</span></label>
