  <x-layout>
    <div class="container mx-auto px-4 py-20 md:px-6">
        <div class="text-center mb-16">
            ...
            <h2 class="text-4xl font-bold text-blue-900 mb-4">About Us</h2>
                ...
                <div class="left flex-1 mb-6 md:mb-0 px-10">
                    <div class="content">
                        ...
                        <p class="text-gray-700 mt-4 text-justify">
                            Barangay San Agustin is located in the heart of our city, and it has always been at the forefront of community development. We strive to create a safe and vibrant environment for all of our residents. Our vision is to be a model barangay, providing excellent services to our people.
                        </p>
                        
                        <p class="text-gray-700 mt-4 text-justify">
                            Our mission is to ensure the well-being of every individual by promoting transparency, providing accessible services, and fostering community engagement. With various programs and initiatives, we aim to uplift the quality of life for everyone living in San Agustin.
                        </p>
                        
                        <p class="text-gray-700 mt-4 text-justify">
                            As a barangay, we value unity and cooperation among our citizens. Through our continued efforts in improving facilities, enhancing safety, and encouraging civic participation, we are building a stronger and more resilient community for the future.
                        </p>
                    </div>
                </div>
